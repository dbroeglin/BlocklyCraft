...
function bukkitSetTimeout(callback, delayInMillis) {
  ...
  var task = server.scheduler["runTaskLater(org.bukkit.plugin.Plugin, java.lang.Runnable, long)"](__plugin, callback, delay);
...
function bukkitSetInterval(callback, intervalInMillis) {
  ...
  var task = server.scheduler["runTaskTimer(org.bukkit.plugin.Plugin, java.lang.Runnable, long, long)"](__plugin, callback, delay, delay);
